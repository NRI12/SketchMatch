...
class DualEncoder(nn.Module):
    def __init__(
        ...
        sketch_feat_dim = self.sketch_encoder.num_features
        photo_feat_dim = self.photo_encoder.num_features
        
        self.sketch_projector = ProjectionHead(sketch_feat_dim, 256, embedding_dim)
        self.photo_projector = ProjectionHead(photo_feat_dim, 256, embedding_dim)
